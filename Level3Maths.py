...
class Level3Maths:
    ...
    def __init__(self):
        ...
        self.root.title("Level 3 Maths")  # title refers to the name provided to the window. It appears on the top of the
        ...
        with open("Level3MathsQuestions.json",
    ...
    def SelectNextQuestion(self):
        ...
        while status:  # while status is True
            ...
            if len(self.QuestionUsed) >= 2:  # if the length of the list of the question that have been used
                # are bigger then 2
                try:
                    StoreResults.storeResults(self.countWrong, self.countCorrect, "Level3Maths", self.WrongQuestions,
                                              self.TheirAnswer)
