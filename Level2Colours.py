...
class Level2Colours:
    def __init__(self):
        ...
        self.root.title(
            "Level 2 Colours")  # title refers to the name provided to the window. It appears on the top of the
        ...
        with open("Level2ColoursQuestions.json",
