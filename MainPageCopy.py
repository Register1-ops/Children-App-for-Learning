...
class LevelOptions():
    def __init__(self):
        ...
        self.Animation_canvas = self.create_animation_canvas()
        ...
        #thread = threading.Thread(target=self.animate_ball, args=(self.Animation_Window, self.Animation_canvas, self.Ball_min_movement, self.Ball_min_movement))
        #thread.start()
        ...
        #self.root.mainloop()
        self.animate_ball(self.Animation_canvas, self.Ball_min_movement, self.Ball_min_movement)
    ...
    def animate_ball(self, canvas, xinc, yinc):
        ball = canvas.create_oval(self.Ball_Start_XPosition - self.Ball_Radius,
    ...
    def FirstPage(self, UserID):
        ...
        self.rootFrame = tk.Frame(
            self.Animation_canvas)  # accessing Tkinter, in a variable root, so everything can be stored inside the root
